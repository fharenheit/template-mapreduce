...
public class FileSelectorChain implements org.openflamingo.mapreduce.util.FileSelector {
     ...
     * File Selector 목록
     */
    private List<org.openflamingo.mapreduce.util.FileSelector> fileSelectors;
    ...
    public String getTargetHdfs(String filename) {
        for (Iterator<org.openflamingo.mapreduce.util.FileSelector> fileSelectorIterator = fileSelectors.iterator(); fileSelectorIterator.hasNext(); ) {
     ...
     */
    public void setFileSelectors(List<org.openflamingo.mapreduce.util.FileSelector> fileSelectors) {

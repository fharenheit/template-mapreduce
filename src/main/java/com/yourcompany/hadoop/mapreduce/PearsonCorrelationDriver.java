 ...
 * @version 0.1
 */
public class PearsonCorrelationDriver extends org.apache.hadoop.conf.Configured
        implements org.apache.hadoop.util.Tool {

    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new PearsonCorrelationDriver(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        // Mapper Class
        job.setMapperClass(PearsonCorrelationMapper.class);
        job.setReducerClass(PearsonCorrelationReducer.class);
